...
export default function Home() {
    ...
    return (
        <div className="flex flex-col items-center justify-center pt-20 pb-16">
            ...
            >
                <motion.div variants={containerCallback(0)} className="space-y-4">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-surface border border-white/10 mb-4">
                ...
                >
                    <Link href="/create">
                        <Button size="lg" className="text-lg px-8 h-14 rounded-full">
                            Start a Campaign <ArrowRight className="ml-2 w-5 h-5" />
                        </Button>
                    </Link>
                    <Link href="/campaigns">
                        <Button
            ...
            <motion.div
                ...
                className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-32 max-w-7xl mx-auto w-full"
            >
                {[
                    {
                        icon: Shield,
                    ...
                    <motion.div
                        ...
                        className="p-8 rounded-2xl bg-surface/30 border border-white/5 hover:bg-surface/50 transition-colors"
                    >
